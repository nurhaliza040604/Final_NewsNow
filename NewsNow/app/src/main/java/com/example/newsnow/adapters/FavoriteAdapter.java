...
public class FavoriteAdapter extends RecyclerView.Adapter<HomeViewHolder> {
    private Context context;
    private List<NewsHeadLines> headLines;
    private SelectListener listener;

    public FavoriteAdapter(Context context, List<NewsHeadLines> headLines, SelectListener listener) {
